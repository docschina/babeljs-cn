...
此版本默认启用 [类静态初始化块](https://github.com/tc39/proposal-class-static-block)。它包括对 [管道操作符](https://github.com/tc39/proposal-pipeline-operator) 提案的新变体，以及 TypeScript 4.5 兼容性的支持。
...
如果你或你的公司希望支持 Babel 和 JavaScript 的发展，但不确定该怎么做，你可以在我们的 [Open Collective](https://github.com/babel/babel?sponsor=1)上给我们捐款，更好的方式是，直接与我们合作实现 [新的 ECMAScript 提案](https://github.com/babel/proposals)！作为志愿者驱动的项目，我们依靠社区的支持，来资助我们为广泛的 JavaScript 用户提供支持所做的努力。如果你想讨论更多内容，请联系 [team@babeljs.io](mailto:team@babeljs.io)！
...
TypeScript 4.5 引入了用于将导入标记为仅类型的新语法：你可以标记单个说明符，而不是标记整个 import 语句：
```ts
// TypeScript 4.4
