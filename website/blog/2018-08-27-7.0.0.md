...
Babel 自身 [更快](https://twitter.com/left_pad/status/927554660508028929) 所以它应该花更少的构建时间！我们做了很多更改来优化代码以及
 [接受](https://twitter.com/bmeurer/status/924346958810107904) 来自 [v8](https://twitter.com/v8js) 团队的 [补丁](https://twitter.com/rauchg/status/924349334346276864) 。我们很高兴与许多其他优秀的 JavaScript 工具一起成为 [Web Tooling Benchmark](https://github.com/v8/web-tooling-benchmark) 的一部分。
...
我们再次参加[Rails Girls Summer of Code](https://railsgirlssummerofcode.org/) again! This time, [Gyujin](https://twitter.com/MarinaGJCho)！这次，[Gyujin](https://twitter.com/MarinaGJCho) 和 [Sujin](https://twitter.com/sujinleeme) 一直在努力将 [Boopathi's](https://twitter.com/heisenbugger) 的 [babel-time-travel](https://github.com/babel/babel-time-travel) 整合到 REPL 中，现在已经可以测试了！
